...
$.fn.combobox_createTwoDotZero = function(valueField, textField, url, needSetText, addSelectAll, isShowDefault) {
	var divObj = this;
	divObj.combobox({
	...
	$.ajax({
		...
		success : function(returnData) {
			if (addSelectAll == undefined) {
				addSelectAll = false;
			}
			if (isShowDefault == undefined) {
				isShowDefault = false;
			}
			...
			if (addSelectAll) {
				...
				var optionNamedAll = '{' + valueField + ':' + value + ',' + textField + ':' + '\'全部\'' + '}';
				console.info(optionNamedAll);
				returnData.unshift(eval('(' + optionNamedAll + ')'));
			}
			console.info(returnData);
			divObj.combobox('loadData', returnData);
			divObj.combobox('clear');
			if (needSetText != undefined) {
				divObj.combobox_setText(valueField, textField, needSetText);
			}
		},
		error : function() {
			$.messager.show({
